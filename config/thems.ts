export const themes = [
  {
    ...
    cssVars: {
      light: {
        ...
        tooltipBackground: '222.2 47.4% 11.2%', // Tambahkan: warna latar tooltip (misalnya, abu-abu tua)
        tooltipText: '210 40% 98%', // Tambahkan: warna teks tooltip (misalnya, putih)
      },
      dark: {
        ...
        tooltipBackground: '217.2 32.6% 17.5%', // Tambahkan: warna latar tooltip (misalnya, abu-abu gelap)
        tooltipText: '210 40% 98%', // Tambahkan: warna teks tooltip (misalnya, putih)
      },
    },
  },
