...
> = {
  ...
  SUJUD: { from: '#c026d3', to: '#f0abfc', border: '#c026d3' }, // Magenta
  ...
  RIZAL: { from: '#5b21b6', to: '#a78bfa', border: '#5b21b6' }, // Deep Indigo-Purple
  ...
  'SETIADI ELM': { from: '#4b5563', to: '#9ca3af', border: '#4b5321' }, // Gray
